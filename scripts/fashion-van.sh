...
hardness=$2
mastery=$3
root=/home2/lgfm95/fashionMnist/

if [ ${dataset} == 'cifar10' ] || [ ${dataset} == 'cifar100' ] || [ ${dataset} == 'mnist' ] || [ ${dataset} == 'fashion' ]; then
...
python3 ./exps/basic-main.py --dataset ${dataset} \
	...
	--name ${dataset} \
	--model_config ./configs/archs/NAS-${base}-${model}-GRAY.config \
