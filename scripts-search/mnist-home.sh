...
#--dataset mnist --data_path /hdd/PhD/data/mnist --model_config ./configs/archs/CIFAR-ResNet110.config --split_path   ./.latent-data/splits/mnist-0.5.pth --optim_config ./configs/search-opts/CIFARX.config --procedure search-v2 --FLOP_ratio 0.47 --FLOP_weight 2 --FLOP_tolerant 0.05 --save_dir ./output/search-shape/mnist-ResNet110-CIFARX-Gumbel_0.1-5-0.47 --gumbel_tau_max 5 --gumbel_tau_min 0.1 --cutout_length -1 --batch_size 256 --rand_seed -1 --workers 6 --eval_frequency 1 --print_freq 100 --print_freq_eval 200 --init_train_epochs 5 --dynamic 1 --subset_size 100 --hardness 0.9 --mastery 0.4
